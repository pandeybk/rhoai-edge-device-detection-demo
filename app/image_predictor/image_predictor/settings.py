"""
Django settings for image_predictor project.
...
SECRET_KEY = "django-insecure-0=(aitbsm1(^j(35pv4n$df!dllx&cp(wlche)-^@&s)wk(^ug"
...
ROOT_URLCONF = "image_predictor.urls"
...
WSGI_APPLICATION = "image_predictor.wsgi.application"
